...
**§3 addendum (S49, 2026-07-06): the 9k rung reopened + fixed.** Patrick (2d) went 2-4 vs 9k EVEN — and the local baseline confirmed the ladder was INVERTED at that pair (9k beat the 6k anchor 5/8). Weakened via overall level per Patrick's call (rr .12→.10, temp 2.1→2.2, λ .25→.30; blunder knobs untouched); ordering restored on both instruments (6k beats 9k 6/8; mean loss +17%, middle-game concentrated). Detail: DEVJOURNAL S49. Lesson recorded: per-move histograms can match the human column while game-level strength runs ranks hot — Patrick's even-game record is the instrument for that class. Closes with the same device pass as S47-48.
